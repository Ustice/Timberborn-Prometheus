...
Continue Wave D after P2S-013. Use `bash scripts/build.sh --qa`, then Computer Use for startup dialogs, save loading, and in-game evidence when a ticket requires live QA.
