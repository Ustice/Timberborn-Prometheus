...
Phase 2 stabilization is now running from the file board under `docs/stabilization/tickets/`. Wave A, Wave B, Wave C, Wave D, P2S-019, P2S-020, P2S-022, and P2S-023 are integrated and done, with P2S-021 ready for review. This includes P2S-009 reset-registry live QA, P2S-013 configured-source startup QA, P2S-017 effect-facade startup QA, native recovered-good spawning/storage proof for Fertile Ash, dependency-light field amendment state, the crop growth buff for active amendments, and ash reset telemetry that clears Prometheus ash queue evidence without destroying Timberborn-owned recovered-good stacks.
...
P2S-021 is ready for orchestrator review. Next, assign P2S-024 to discover the farmhouse ash application path without implementing the P2S-025 application flow.
