...
* Latest verified results:
  ...
  * The debug panel is reorganized into native-style tabs (`Actions`, `Visuals`, `Selection`, `Log`) so unused tools collapse away; visible UI colors now route through `PrometheusDebugPalette`.
