...
namespace Prometheus.Tests
{
    public sealed class PrometheusRepoGuardrailTests
    {
        ...
        private static readonly string[] ExpectedTestCompileItems =
        {
            ...
            "Core/PrometheusSingletonLifecycles.cs",
            ...
            "Fire/Recovery/FarmHouseFertileAshAmendmentWorkplaceBehavior.cs",
            "Fire/Recovery/FertileAshRecoveredGoodStackSpawner.cs",
            "Fire/Recovery/FireAftermathEligibilityPolicy.cs",
            "Fire/Recovery/FireBurnedGroundAshDepositRuntimeState.cs",
        ...
        private static readonly string[] QaTelemetryEvents =
        {
            ...
            FireTelemetryEvents.FireSuppressionAreaQueued,
            FireTelemetryEvents.FireSuppressionAreaApplied,
            FireTelemetryEvents.FireSuppressionAreaExpired,
            ...
            FireTelemetryEvents.QaCommandResult,
            ...
            FireTelemetryEvents.FertileAshFarmhouseAmendmentApplied,
            FireTelemetryEvents.FertileAshFarmhouseAmendmentSkipped,
            ...
            FireTelemetryEvents.FertileAshTreeRemnantYieldApplied,
            FireTelemetryEvents.FertileAshTreeRemnantYieldFailed,
            FireTelemetryEvents.BurnedGroundAshDepositCreated,
            FireTelemetryEvents.BurnedGroundAshDepositMarkerCreated,
            FireTelemetryEvents.BurnedGroundAshDepositsReset,
            FireTelemetryEvents.BurnedGroundAshDepositMarkersReset,
        ...
        public void QaTelemetryEvents_AreStableAndRegistered_Test()
        {
            var expectedTokens = new[]
            {
                ...
                "fire_suppression_area_queued",
                "fire_suppression_area_applied",
                "fire_suppression_area_expired",
                ...
                "fertile_ash_farmhouse_amendment_applied",
                "fertile_ash_farmhouse_amendment_skipped",
                ...
                "fertile_ash_tree_remnant_yield_applied",
                "fertile_ash_tree_remnant_yield_failed",
                "burned_ground_ash_deposit_created",
                "burned_ground_ash_deposit_marker_created",
                "burned_ground_ash_deposits_reset",
                "burned_ground_ash_deposit_markers_reset",
